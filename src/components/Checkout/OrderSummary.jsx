...
const OrderSummary = () => {
  ...
  return (
    <div>
     <div className="w-full  p-5 bg-white my-5 mr-7 rounded-xl shadow-xl">
       <h2 className="text-xl font-bold mb-1">Delivery Addresses</h2>
         <div >
    ...
    <div className=" bg-gray-100">
      ...
      <div className="mx-auto justify-center px-6 md:flex md:space-x-6 xl:px-0">
        ...
        {/* checkout */}
        <div className="mt-6 h-full rounded-xl bg-white border p-6 shadow-md md:mt-0 md:w-1/3 mb-48">
