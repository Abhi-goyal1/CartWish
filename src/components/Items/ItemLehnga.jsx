...
const filters = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: "2500 3000", label: "2500 - 3000", checked: false },
    ],
  },
  {
    id: "category",
  ...
  },
  {
    ...
    options: [
      ...
      { value: "40", label: "40% And Above", checked: true },
...
export default function ItemLehenga() {
        ...
        <main className="mx-auto  px-4 sm:px-6 lg:px-8 bg-stone-100 p-2">
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4 ">
              ...
              <form className="hidden lg:block bg-white p-4 rounded-2xl  shadow-2xl dark:bg-gray-800">
                <div className="flex justify-between items-center">
                  {" "}
                  <h1 className="text-xl lg:text-1xl font-bold tracking-tight  text-gray-900">
                    {" "}
                    Filters
                  </h1>
